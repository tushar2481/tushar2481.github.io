...
<body style="background-color: #290658;">
    ...
    <div class="main">
        <h1 id="heading-1">Payment Portal!</h1>

<!-- ------------------------------------------------------------------------------------------------------------------------- -->
<center>
          <img src="/img/barcord.png" alt="There is some problem in payment, please wait!!" width="500" height="500" > 
          <br><br>
          <a style="font-family: 'Raleway', sans-serif; font-size: xx-large; color: #ffffff;" target="_blank" href="https://docs.google.com/forms/d/e/1FAIpQLSdr7lW4Q2FIXiQGRqTOnZt5WMF2QD5_UK17YjeotuJ9g8foIg/viewform?usp=sf_link">Please Make a payment and fill the form we will get back to you in 24 hours!</a>
          <!-- <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdr7lW4Q2FIXiQGRqTOnZt5WMF2QD5_UK17YjeotuJ9g8foIg/viewform?usp=sf_link" width="800" height="800" frameborder="0" marginheight="0" marginwidth="0">
          Loading…
          </iframe> -->
</center>
<!-- ------------------------------------------------------------------------------------------------------------------------- -->
