...
<br>
    ...
    <h2
        ...
        Course</h2>
        <br>
        <pre style="border-top: 1px solid rgb(104, 87, 255);"></pre><br>
        <center><form action="/kali.php">
          <h1 style="font-size: 45px;">
          Snort Installation In Kali Linux
          </h1>
          <iframe width="60%" height="500" src="https://www.youtube.com/embed/PPDrIOnYwCQ?autoplay=1">
          </iframe> <br><br>
          <input type="submit" value="Previous" id="pcontent" src="/kali.php" style="font-size: 20px; padding: 10px 15px; margin-left:670px; background-color: rgb(0, 2, 116); color: white;">
          <input type="submit" value="Next" id="ncontent" src="/kali.php" style="font-size: 20px; padding: 10px 25px; margin-left: 30px; background-color: rgb(0, 2, 116); color: white;" >
        </form></center>
    <br><br><br>
    <center>
    <div id="contact">
