...
<br>
    ...
    <h2
        ...
        <form action="/php/updatepass.php" method="POST" onsubmit="return validate()">
            <div id="frm">
            <label for="pass" class="lgin">Mail id&nbsp;&nbsp; </label>
            <input type="text" name="mail" id="Pass" placeholder="enter mail id" class="lgin-ip" minlength="8" style="margin-left: 38px;">
            <p id="p1"></p><br>
            ...
            <br><br>
            <a href="/login.html" id="link" style="text-decoration: none; font-family: cursive;">//Back to Login page.//</a>
        </div>
        </form>
        </center>
    <br><br><br>
