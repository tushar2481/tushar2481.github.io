...
<body style="background-color: #1a003e;">
    <!-- background-image: linear-gradient(to bottom, #1a003e,#1a003e,#ffffff ); -->
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <form action="/edit-profile.php" method="post">
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0" style="text-align: center; padding-top: 7px;">Full Name</h6>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0" style="text-align: center; padding-top: 7px;">Email</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                        <input type="email" name="email" class="form-control" placeholder="john.trusts3c@gmail.com">
                                    </div>
                                </div>
                                <hr>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0" style="text-align: center; padding-top: 7px;">Phone</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="phn" class="form-control" placeholder="9123456780">
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0" style="text-align: center; padding-top: 7px;">Address</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="address" class="form-control" placeholder="Ahmedabad, India">
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
